...
# the total area of all polygons. Need to union them because multiple polygons
...
# bc_sk_by_subzone <- st_read(file.path(bc_maps_dir, "iapp_sk_by_subzone.gpkg"), quiet = TRUE)
