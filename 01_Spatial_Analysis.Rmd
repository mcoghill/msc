...
suppressMessages(suppressWarnings({
  ls <- c("tidyverse", "bcmaps", "bcdata", "sf", "foreach", "measurements", "tabulizer")
...
unzip(file.path(data_dir, "Matt.kmz"), exdir = msc_map_dir, overwrite = TRUE)
layers <- st_layers(file.path(msc_map_dir, "doc.kml"))$name
field_data <- sapply(layers, function(x)
  st_read(file.path(msc_map_dir, "doc.kml"), layer = x, quiet = TRUE), 
