...
# Write outputs
st_write(temp_sites, file.path(layer_dir, "all_thermochron_locations.gpkg"), 
         delete_layer = TRUE, quiet = TRUE)
st_write(site_list, file.path(layer_dir, "thermochron_analysis_locations.gpkg"),
         delete_layer = TRUE, quiet = TRUE)
